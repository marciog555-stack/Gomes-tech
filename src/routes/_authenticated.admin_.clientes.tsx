          ...
          editingId === c.id ? (
            ...
            >
              ...
              <div className="flex gap-4">
                <button onClick={() => setEditingId(c.id)} className="admin-action-link caption-brand items-center gap-1 text-cyan-500" style={{ fontWeight: 600 }}>
                  <Pencil size={13} />
                  Editar
                </button>
                <button onClick={() => handleDelete(c.id)} className="admin-action-link caption-brand items-center gap-1" style={{ fontWeight: 600, color: '#c0392b' }}>
                  <Trash2 size={13} />
                  Excluir
                </button>
              </div>
